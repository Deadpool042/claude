      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid gap-3 md:grid-cols-2">
          <div className="rounded-lg border p-3 text-sm">
            ...
            {qualification?.wasRequalified ? (
              <div className="mt-3 flex items-center gap-2 text-xs text-amber-600 dark:text-amber-400">
                ...
                Requalifié depuis {CATEGORY_SHORT[qualification.initialCategory]}
              </div>
            ) : null}
          </div>
          ...
          <div className="rounded-lg border border-dashed p-3 text-sm">
            ...
            <p className="mt-1 text-muted-foreground">{discoveryInsights.posture}</p>
        ...
        {suggestedModuleLabels.length > 0 ? (
          <div className="space-y-2 rounded-lg border border-dashed p-3 text-xs">
            ...
            <p className="text-muted-foreground">{suggestedModuleLabels.join(" · ")}</p>
        ...
        {discoveryInsights.warnings.length > 0 ? (
          ...
          <InlineHint>
            Les éléments métier sont suffisamment lisibles pour relire la recommandation sans revenir à chaque question.
          </InlineHint>
        )}
      </CardContent>
    </Card>
