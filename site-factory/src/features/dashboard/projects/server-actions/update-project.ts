...
export async function updateProjectAction(
  ...
  const manualEstimatedBudget = parsed.data.qualification?.estimatedBudget ?? null;
  ...
  const resolvedProjectImplementationId =
    parsed.data.projectImplementationId ??
    resolveCmsIdFromImplementation(
      parsed.data.projectImplementation ?? null,
      parsed.data.projectImplementationLabel ?? "",
    ) ??
    existing.projectImplementationId;
    ...
    await prisma.$transaction(async (tx) => {
      ...
      await tx.project.update({
        ...
        data: {
          ...
          projectFamily: parsed.data.projectFamily ?? existing.projectFamily ?? null,
          projectImplementation: parsed.data.projectImplementation ?? existing.projectImplementation ?? null,
          projectImplementationId: resolvedProjectImplementationId ?? null,
          projectImplementationLabel:
            parsed.data.projectImplementationLabel ?? existing.projectImplementationLabel ?? null,
          projectFrontendImplementation:
            parsed.data.projectFrontendImplementation ??
            existing.projectFrontendImplementation ??
            null,
          projectFrontendImplementationLabel:
            parsed.data.projectFrontendImplementationLabel ??
            existing.projectFrontendImplementationLabel ??
            null,
