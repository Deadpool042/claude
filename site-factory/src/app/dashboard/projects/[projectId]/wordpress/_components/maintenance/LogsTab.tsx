  ...
  return (
    <>
      <div className="rounded-lg border p-4 space-y-4">
            ...
            <ConfirmDialog
              ...
              description={
                <div className="space-y-1 text-xs text-muted-foreground">
                  <p>Supprime les logs pour le scope selectionne.</p>
                  <p>Env: {logEnvLabel}</p>
        ...
        {isProd ? (
          <p className="text-xs text-muted-foreground">
            Les logs en production seront disponibles quand la cible sera branchee.
          </p>
        ) : null}
      </div>
      ...
      <div className="rounded-lg border overflow-hidden">
        {logEntries.length === 0 ? (
          <div className="p-4 text-xs text-muted-foreground">
            Aucun log pour la periode selectionnee.
          </div>
        ) : (
