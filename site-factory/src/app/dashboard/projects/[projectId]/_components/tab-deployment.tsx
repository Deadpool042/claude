...
import { updateDeploymentAction } from "../../_actions/update-deployment";
import { Button } from "@/components/ui/button";
import { Badge } from "@/components/ui/badge";
import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from "@/components/ui/card";
import { DEPLOY_TARGET_LABELS } from "@/lib/validators/project";
...
import { isDeployTargetLiteral, type DeployTargetLiteral } from "@/lib/service-catalog";
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader className="pb-4">
          ...
          <CardDescription>Preconfiguration automatique selon la cible d'hebergement.</CardDescription>
        </CardHeader>
      ...
      <Card>
        <form action={formAction}>
          <CardHeader className="pb-4">
            <CardTitle className="text-base">Hebergeur</CardTitle>
            <CardDescription>
              L&apos;hebergeur pilote le profil technique et les contraintes de deploiement.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              >
                {providers.map((provider) => {
                  const suffix = provider.id === recommendedProviderId ? " - recommande" : "";
                  return (
            ...
            {state.success ? (
              <p className="text-sm text-green-600">Hebergeur mis a jour.</p>
            ) : null}
          </CardContent>
          <CardFooter>
