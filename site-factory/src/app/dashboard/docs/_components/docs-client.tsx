              ...
              <div className="flex flex-wrap items-center gap-2 text-xs">
                ...
                {selectedProject && projectDocIds.size === 0 ? (
                  <span className="text-amber-300">
                    Docs projet non synchronisees. Lancez la synchronisation.
                  </span>
                ) : null}
                {syncStatus ? (
          ...
          {loadingList ? (
            ...
            <div className="space-y-3 text-sm text-muted-foreground">
              {scope === "project" && !showAllDocs && !hasProjectDocs ? (
                <>
                  <div>
                    Aucun document projet disponible. Synchronisez pour generer la
                    selection.
                  </div>
                  <Button
                    size="sm"
      ...
      <Card className="relative z-0 flex h-180 min-w-0 flex-col overflow-hidden border-border/60 bg-card/40 p-5 shadow-sm pointer-events-auto">
        {selectedDoc ? (
            ...
            >
              ...
              <TabsContent value="edit" className="mt-4 min-h-0 overflow-hidden">
                ...
                <div className="mt-2 text-xs text-muted-foreground">
                  Astuce: utilisez le mode Apercu pour verifier la mise en forme.
                </div>
              </TabsContent>
              <TabsContent value="info" className="mt-4 space-y-3">
                ...
                <div className="rounded-lg border border-border/60 bg-muted/20 p-3 text-xs text-muted-foreground">
                  Documentation locale. Les changements sont ecrits directement
          ...
          <EmptyState
            ...
            description="Choisissez un document dans la colonne de gauche pour commencer l'edition."
          />
        )}
      </Card>
      </div>
