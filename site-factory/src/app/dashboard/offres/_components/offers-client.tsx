...
const MODULE_CATEGORY_CARD_STYLES: Record<ModuleCategory, string> = {
...
export function OffersClient() {
  ...
  const [projectType, setProjectType] = useState<ProjectType>(PROJECT_TYPE_ORDER[0]);
  const [stack, setStack] = useState<Stack>(DEFAULT_STACK_BY_PROJECT_TYPE[PROJECT_TYPE_ORDER[0]]);
  ...
  const toggleOptionalModule = (moduleId: ModuleId) => {
  ...
  const openModuleDetails = (moduleId: ModuleId) => {
    setActiveModuleId(moduleId);
    setDetailsOpen(true);
  };

  useEffect(() => {
    const allowedStacks = PROJECT_TYPE_STACKS[projectType];
    if (!allowedStacks.includes(stack)) {
      setStack(DEFAULT_STACK_BY_PROJECT_TYPE[projectType]);
    }
  }, [projectType, stack]);
  ...
  const stackOptions = PROJECT_TYPE_STACKS[projectType];
  ...
  const includedModules = includedModuleIds.map((id) => getModuleById(id));
  ...
  const availableModules = useMemo(() => {
    if (projectType === "STARTER") return [] as ModuleDef[];
  ...
  const renderModuleDetails = (module: ModuleDef) => (
    <div className="space-y-4 text-sm">
      ...
      <div className="space-y-1">
        <p className="text-xs text-muted-foreground">Compatibilite</p>
  ...
  return (
    <>
      ...
      <Tabs value={projectType} onValueChange={(value) => setProjectType(value as ProjectType)}>
          ...
          <div className="grid gap-6 lg:grid-cols-[1.1fr_1.9fr]">
            ...
            <Card className="transition hover:shadow-lg">
              <CardHeader className="pb-4">
                ...
                <CardDescription>
                  A partir de, selon la stack et la qualif du projet.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className={`rounded-lg border p-4 ${CATEGORY_PANEL_STYLES[catBase]}`}>
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">
                    Stack selectionnee: {STACK_LABELS[stack]}
                  </p>
                </div>
            ...
            <Card className="transition hover:shadow-lg">
              <CardHeader className="pb-4">
                ...
                <CardDescription>Configuration initiale et deploiement.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3 text-sm">
            ...
            <Card className="transition hover:shadow-lg">
              <CardHeader className="pb-4">
                ...
                <CardDescription>Resume rapide des facteurs.</CardDescription>
              </CardHeader>
          ...
          <div className="space-y-6">
            <Card className="transition hover:shadow-lg">
              ...
              <CardContent className="space-y-3 text-sm">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-muted-foreground">Deploiement</span>
                ...
                {selectedModules.length > 0 ? (
                  <div className="rounded-md border border-border/60 bg-muted/30 px-3 py-2">
                    <p className="text-xs font-medium">Modules selectionnes</p>
            ...
            <Card className="transition hover:shadow-lg">
              <CardHeader className="pb-4">
                ...
                <CardDescription>
                  Filtrage par categorie, recherche, compatibilite.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
