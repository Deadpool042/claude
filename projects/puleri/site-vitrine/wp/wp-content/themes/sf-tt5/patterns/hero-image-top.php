<?php
/**
 * Title: Composant — Hero image dessus (SF)
 * Slug: sf-tt5/hero-image-top
...
<div class="wp-block-group alignfull has-surface-background-color has-background" style="padding-top:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--xl)">
  ...
  <h2 class="wp-block-heading has-text-align-center has-2xl-font-size">Un hero centre avec image au-dessus</h2>
  <!-- /wp:heading -->
  <!-- wp:paragraph {"textAlign":"center","fontSize":"md"} -->
  <p class="has-text-align-center has-md-font-size">Ajoute une image forte puis un message clair et des actions visibles.</p>
  <!-- /wp:paragraph -->
