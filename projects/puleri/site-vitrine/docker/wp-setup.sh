...
if ! wp core is-installed --allow-root >/dev/null 2>&1; then
  ...
  wp post create --post_type=page --post_title="Nos services" --post_name="nos-services" --post_status=publish --allow-root
  wp post create --post_type=page --post_title="Réalisations" --post_name="realisations" --post_status=publish --allow-root
